...
public class StickyScrollView extends ScrollView {
	 ...
	 */
	private static final int MIN_STICK_TOP = DensityHelper.dip2px(50);// px
	...
	private IOnScrollChanged mOnScrollHandler = null;
	...
	public void setOnScrollChangedListener(IOnScrollChanged handler) {
